...
class ProfessionalAreaViewMixin(ModelFormMixin):
    """
    Mixin para compartir funcionalidades comunes entre las vistas
    relacionadas con las áreas profesionales del test vocacional.
    """
    ...
    def get_form(self, form_class=None):
        ...
        form.fields['name'].widget.attrs.update({
            'class': 'form-control',
            'placeholder': 'Ingrese el nombre del área profesional'
        })
